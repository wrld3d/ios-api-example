...
- (void)viewDidLoad {
    ...
    self.samples = @[
        ...
        [SampleInfo infoForSample:[AccuracyRingArroundBlueSphere class]],
        ...
        [SampleInfo infoForSample:[PickBuildings class]],
        [SampleInfo infoForSample:[PlaceObjectsOnBuildings class]],
        [SampleInfo infoForSample:[HighlightIndoorMapEntities class]],
        [SampleInfo infoForSample:[PickIndoorMapEntities class]],
        [SampleInfo infoForSample:[QueryIndoorMapEntityInformation class]],
